    ...
    function (t, e, n) {
        ...
        var c = {
            ...
            remove: function (t) {
                ...
                (e = d(t)) > -1 &&
                    (o.splice(e, 1),
                        !o.length && u && (a.call(window, u), (u = null)));
            },
        },
            f = (function () {
                function t(t, e) {
        ...
        function m(t) {
            return (
                t && "number" == typeof t.clientX && "number" == typeof t.clientY
            );
        }
        function g(t) {
            t.preventDefault();
                ...
                f(
                    ...
                    [
                        ...
                        },
                        {
                            key: "addStartHandler",
                            value: function (t, e) {
                                if (!this.startHandlers[e])
                                    throw new Error("Invalid handlerId: " + e);
                                return (
                                    v(t, "mousedown", this.startHandlers[e], {
                                        capture: !1,
                                        passive: !1,
                                    }),
                                    ...
                                    v(t, "dragstart", g, { capture: !1, passive: !1 }),
                                    e
                                );
                            },
                        },
                            ...
                            value: function (t, e) {
                                var n = this,
                                    r = c.add(function (t) {
                                        ...
                                        if (
                                            ("touch" === e && (n.lastTouchTime = Date.now()),
                                                e === n.curPointerClass)
                                        ) {
                                            var r =
                                                "touch" === e
                                                    ? h(t.changedTouches, n.curTouchId)
                                                    : t;
                                            m(r) &&
                                                ((r.clientX === n.lastPointerXY.clientX &&
                                                    r.clientY === n.lastPointerXY.clientY) ||
                                                    n.move(r),
                                                    n.options.preventDefault && t.preventDefault(),
                                                    n.options.stopPropagation && t.stopPropagation());
                                        }
                                    });
                                v(t, "mousemove", r, { capture: !1, passive: !1 }),
                                    v(t, "touchmove", r, { capture: !1, passive: !1 }),
                                    (n.curMoveHandler = e);
                            },
                        },
                        {
                            ...
                            value: function (t) {
                                m(t) &&
                                    ((this.lastPointerXY.clientX = t.clientX),
                                        (this.lastPointerXY.clientY = t.clientY)),
                                    this.curMoveHandler &&
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                v(t, "mouseup", r, { capture: !1, passive: !1 }),
                                    v(t, "touchend", r, { capture: !1, passive: !1 }),
                                    (n.curEndHandler = e);
                            },
                        },
                        {
                        ...
                        n = {
                            ...
                            toggle: function (n, r) {
                                return (function (t, e, n, r) {
                                    ...
                                    return -1 !== o
                                        ? !!r || (t.splice(o, 1), _(t, e), !1)
                                        : !1 !== r && (t.push(n), _(t, e), !0);
                                })(e, t, n, r);
                            },
        ...
        var A = 9e3,
            ...
            Q = (function () {
                ...
                return function (r) {
                    ...
                    return (
                        r &&
                        "[object Object]" === t.call(r) &&
                        (!(o = Object.getPrototypeOf(r)) ||
                            ((i = o.hasOwnProperty("constructor") && o.constructor) &&
                                "function" == typeof i &&
                                e.call(i) === n))
                    );
                };
                ...
                ["x", "y"].forEach(function (e) {
                    ...
                    if (n) {
                        var r = t - n.lastFrameTime,
                            o = Ot(Ct, e),
                            i =
                                null != n.lastValue && Math.abs(n.lastValue - o) < 10
                                    ? n.lastValue
                                    : o;
        ...
        function kt(t, e, n) {
            return (
                null != n &&
                ("x" === e
                    ? t.scrollTo(n, t.pageYOffset)
                    : t.scrollTo(t.pageXOffset, n)),
        ...
        function _t(t, e) {
            ...
            return (
                ...
                (n = Q(t) ? "obj" : Array.isArray(t) ? "array" : "") !=
                (Q(e) ? "obj" : Array.isArray(e) ? "array" : "") ||
                ("obj" === n
                    ? _t((r = Object.keys(t).sort()), Object.keys(e).sort()) ||
                    r.some(function (n) {
                        return _t(t[n], e[n]);
                    })
                    : "array" === n
        ...
        function Dt(t) {
            return !(
                ...
                t.compareDocumentPosition(document) &
        ...
        function Xt(t) {
            ...
            if (((t.left = t.x = e), !tt((e = t.top)) && !tt((e = t.y))))
                return null;
            if (((t.top = t.y = e), tt(t.width) && t.width >= 0))
                ...
                : "string" == typeof t
                    ? (function (t) {
                        ...
                        return e && tt((n = parseFloat(e[1])))
                            ? { value: (r = !(!e[2] || !n)) ? n / 100 : n, isRatio: r }
                            : null;
                    })(t.replace(/\s/g, ""))
                    : null;
        }
        ...
        function Ft(t) {
            ...
            if (((t.left = t.x = e), !(e = Yt(t.top)) && !(e = Yt(t.y))))
                return null;
            if (((t.top = t.y = e), (e = Yt(t.width)) && e.value >= 0))
                (t.width = e), delete t.right;
            else {
                if (!(e = Yt(t.right))) return null;
                (t.right = e), delete t.width;
            }
            if ((e = Yt(t.height)) && e.value >= 0)
                (t.height = e), delete t.bottom;
            else {
        ...
        function Rt(t, e) {
            ...
            if (
                ((r.left += window.pageXOffset), (r.top += window.pageYOffset), e)
            ) {
        ...
        function Mt(t, e) {
            null == ut &&
                (!1 !== ht && (ut = P.getValue("cursor", ht)),
                    null == ut && (ut = !1)),
                (t.style.cursor = !1 === ut ? e : ut);
        }
        function zt(t) {
            null == st &&
                (!1 !== mt && (st = P.getValue("cursor", mt)),
                    null == st && (st = !1)),
        ...
        function qt(t, e) {
            ...
            if (e.left !== n.left || e.top !== n.top) {
                ...
                return (
                    t.svgTransform.setTranslate(i.x + r.x - o.x, i.y + r.y - o.y),
                    !0
                );
            }
            return !1;
        ...
        function Zt(t) {
            ...
            t.orgStyle
                ? o.forEach(function (e) {
                    (null != t.lastStyle[e] && n[e] !== t.lastStyle[e]) ||
                        (n[e] = t.orgStyle[e]);
                })
        ...
        function $t(t) {
            ...
            return (
                ...
                (n[ct] = i),
                (a.left === r.left && a.top === r.top) ||
                ((n.left = a.left + s.left + "px"),
                    (n.top = a.top + s.top + "px")),
                a
            );
        }
        function Jt(t) {
        ...
        function Kt(t, e) {
            var n = Rt(document.documentElement),
                ...
                o = (t.containmentBBox = t.containmentIsBBox
                    ? jt(t.options.containment, n) || n
                    : Rt(t.options.containment, !0));
            if (
                ((t.minLeft = o.left),
                    (t.maxLeft = o.right - r.width),
                    (t.minTop = o.top),
                    (t.maxTop = o.bottom - r.height),
                    Ut(t, { left: r.left, top: r.top }),
                    t.parsedSnapTargets)
            ) {
                var i = { x: r.width, y: r.height },
                    ...
                    s = t.parsedSnapTargets.reduce(function (t, e) {
                        ...
                        var p = void 0;
                        if ((p = e.element ? Rt(e.element) : null) || e.ppBBox)
                            e.ppBBox && (p = jt(e.ppBBox, s)),
                                p &&
            ...
            if (c) {
                ...
                var f = "scroll" === e,
                    p = (function (t, e, n) {
                        ...
                        return (
                            e
                                ? (r.clientX = r.clientY = 0)
                                : ((c = t.getBoundingClientRect()),
                                    a || (a = getComputedStyle(t, "")),
                                    (r.clientX =
                                        c.left + (parseFloat(a.borderLeftWidth) || 0)),
                                    (r.clientY =
                                        c.top + (parseFloat(a.borderTopWidth) || 0))),
                            r
                        );
                ...
                f
                    ? t.autoScroll &&
                    ((d.scrollWidth = t.autoScroll.scrollWidth),
                        (d.scrollHeight = t.autoScroll.scrollHeight))
                    : ((d.scrollWidth = p.scrollWidth),
                        (d.scrollHeight = p.scrollHeight)),
                    [
                        ["X", "Width", "left", "right"],
                        ["Y", "Height", "top", "bottom"],
                    ].forEach(function (t) {
                        ...
                        if (l < u && l < a) {
                            ...
                            for (
                                var s = [],
                                f = r[n.toLowerCase()],
                                h = c.sensitivity.length - 1;
                                h >= 0;
                                h--
                            ) {
                                var m = c.sensitivity[h],
                                    g = c.speed[h];
                                s.push({ dir: -1, speed: g, position: v[o] + m }),
                                    s.push({ dir: 1, speed: g, position: v[i] - m - f });
                            }
        ...
        function te(t, e) {
            ...
            if (e.containment) {
                var o = void 0;
                Dt(e.containment)
                    ? e.containment !== n.containment &&
                    ((n.containment = e.containment),
                        (t.containmentIsBBox = !1),
                        (r = !0))
                    : (o = Ft(It(e.containment))) &&
                    _t(o, n.containment) &&
                    ((n.containment = o), (t.containmentIsBBox = !0), (r = !0));
            }
            function i(t, e) {
                function n(t) {
                ...
                u &&
                    ("inside" === u || "outside" === u || "both" === u
                        ? (t.edge = u)
                        : ("inside outside" !== u && "outside inside" !== u) ||
                        (t.edge = "both"));
                var s =
                    "string" == typeof e.base ? e.base.trim().toLowerCase() : null;
                return (
                    !s || ("containment" !== s && "document" !== s) || (t.base = s),
                    t
                );
            }
            if (null != e.snap) {
                var a =
                    Q(e.snap) && null != e.snap.targets
                        ? e.snap
                        : { targets: e.snap },
                    l = [],
                    u = i({ targets: l }, a);
                ...
                var s = (Array.isArray(a.targets)
                    ...
                    if (n || Dt(d)) a.push({ element: d }), (s.boundingBox = d);
                        ...
                        a.push({ ppBBox: c }), (s.boundingBox = Wt(c));
                    else {
                        var f = void 0,
                            p = ["x", "y"].reduce(function (t, e) {
                                ...
                                if ((n = Yt(r))) (t[e] = n), (s[e] = Lt(n));
                                    ...
                                    Q(r) &&
                                        ...
                                        (s[e] = { start: Lt(i), end: Lt(a) }),
                                        l &&
                                        ((l.isRatio ? l.value > 0 : l.value >= 2)
                                            ? ((t[e + "Step"] = l), (s[e].step = Lt(l)))
                                            : (f = !0));
                                }
                                return t;
                            }, {});
                    ...
                    if (a.length) {
                        ...
                        var v = s.corner || u.corner,
                            ...
                            g = {
                                ...
                                base: s.base || u.base,
                                center:
                                    "boolean" == typeof s.center ? s.center : u.center,
                ...
                s.length &&
                    ((n.snap = u),
                        _t(s, t.parsedSnapTargets) &&
                        ((t.parsedSnapTargets = s), (r = !0)));
            } else
                e.hasOwnProperty("snap") &&
                    t.parsedSnapTargets &&
                    (n.snap = t.parsedSnapTargets = t.snapTargets = void 0);
            if (e.autoScroll) {
                var d = Q(e.autoScroll)
                    ? e.autoScroll
                    : { target: !0 === e.autoScroll ? window : e.autoScroll },
                    c = {};
                (c.target = Dt(d.target) ? d.target : window),
                    (c.speed = []),
                    (Array.isArray(d.speed) ? d.speed : [d.speed]).every(function (
                        t,
                        e
                    ) {
                ...
                var f = Array.isArray(d.sensitivity)
                    ? d.sensitivity
                    : [d.sensitivity];
                ...
                e.hasOwnProperty("autoScroll") &&
                    (n.autoScroll && (r = !0), (n.autoScroll = void 0));
            if ((r && Kt(t), Dt(e.handle) && e.handle !== n.handle)) {
                n.handle &&
                    ((n.handle.style.cursor = t.orgCursor),
                        pt && (n.handle.style[pt] = t.orgUserSelect),
            ...
            (tt(e.zIndex) || !1 === e.zIndex) &&
                ((n.zIndex = e.zIndex),
                    t === it &&
                    (t.elementStyle.zIndex =
                        !1 === n.zIndex ? t.orgZIndex : n.zIndex));
        ...
        (wt.move = function (t, e, n) {
            St.call(window, Ht),
                Et(),
                Ct === t &&
                (e.x && Bt.x && (e.x.lastValue = Bt.x.lastValue),
                    e.y && Bt.y && (e.y.lastValue = Bt.y.lastValue)),
                (Ct = t),
                (Bt = e),
                (Ot = n);
            var r = Date.now();
        ...
        var ee = (function () {
            function t(e, n) {
                ...
                if (
                    (Object.defineProperty(this, "_id", { value: ++ot }),
                        (r._id = this._id),
                        (et[this._id] = r),
                        !Dt(e) || e === lt)
                )
                ...
                if (e instanceof SVGElement && (i = e.ownerSVGElement)) {
                    if (!e.getBBox)
                        throw new Error(
                            "This element is not accepted. (SVGLocatable)"
                        );
                    if (!e.transform)
                        throw new Error(
                            "This element is not accepted. (SVGAnimatedTransformList)"
                        );
                    (r.svgTransform = e.transform.baseVal.appendItem(
                        i.createSVGTransform()
                    )),
                        (r.svgPoint = i.createSVGPoint());
                    var a = e.nearestViewportElement;
                    (r.svgCtmElement = $
                        ? a.appendChild(
                            document.createElementNS(i.namespaceURI, "rect")
                        )
                        : a),
                        (o = !1),
                        (r.initElm = Jt),
                    ...
                    l && (o = !1),
                        !n.leftTop && ft
                            ? (l && (e.style[l] = "transform"),
                                (r.initElm = Zt),
                                (r.moveElm = Vt))
                            : (l && (e.style[l] = "left, top"),
                                (r.initElm = $t),
                                (r.moveElm = Gt));
                }
                if (
                    ((r.element = (function (t, e) {
                        ...
                        return (
                            (o && "none" !== o) || (n[r] = "0 0 1px transparent"),
                            ...
                            return (function (t, e) {
                                return !(
                                    ...
                                    (it && Qt(it),
                                        ...
                                        (lt.style.cursor =
                                            st ||
                                            window.getComputedStyle(t.options.handle, "").cursor),
                                        !1 !== t.options.zIndex &&
                                        (t.elementStyle.zIndex = t.options.zIndex),
                                        pt && (lt.style[pt] = "none"),
                                        yt && X(t.element).add(yt),
                                        (it = t),
                                        (at = !1),
                                        (nt.left =
                                            t.elementBBox.left - (e.clientX + window.pageXOffset)),
                                        (nt.top =
                    ...
                    [
                        {
                            ...
                            value: function () {
                                var t = et[this._id];
                                (this.disabled = !0),
                                    rt.unregStartHandler(
                                        rt.removeStartHandler(
                                            t.options.handle,
                                    ...
                                    ((e.disabled = t),
                                        e.disabled
                                            ? (e === it && Qt(e),
                                                ...
                                                pt &&
                                                (e.options.handle.style[pt] = e.orgUserSelect),
                                                gt && X(e.element).remove(gt))
                                            : (Mt(e.options.handle, e.orgCursor),
                                                pt && (e.options.handle.style[pt] = "none"),
                                                gt && X(e.element).add(gt)));
                            },
                        },
                        {
                            key: "element",
                        ...
                        },
                        {
                            ...
                            get: function () {
                                var t = et[this._id];
                                return t.containmentIsBBox
                                    ? Wt(t.options.containment)
                                    : t.options.containment;
                            },
                            set: function (t) {
                                        ...
                                        Object.keys(et).forEach(function (t) {
                                            ...
                                            e.disabled ||
                                                ...
                                                (Mt(e.options.handle, e.orgCursor),
                                                    e === it &&
                                                    ((lt.style.cursor = dt),
                                                        (lt.style.cursor = window.getComputedStyle(
                                                            e.options.handle,
                                                            ""
                                                        ).cursor)));
                                        }));
                            ...
                            set: function (t) {
                                mt !== t &&
                                    ((mt = t),
                                        (st = null),
                                        it &&
                                        (zt(it.options.handle),
                                            !1 === st &&
                                            (Mt(it.options.handle, it.orgCursor),
                                                (lt.style.cursor = dt)),
                                            (lt.style.cursor =
                                                st ||
                                                window.getComputedStyle(it.options.handle, "")
                                                    .cursor)));
                            },
                        },
                        {
        ...
        rt.addMoveHandler(document, function (t) {
            if (it) {
                ...
                if (
                        ...
                        it.snapTargets
                            ? function (t) {
                                ...
                                for (o = 0; o < e && (!n || !r); o++) {
                                    ...
                                    (null == i.gravityXStart ||
                                        t.left >= i.gravityXStart) &&
                                        (null == i.gravityXEnd ||
                                            t.left <= i.gravityXEnd) &&
                                        (null == i.gravityYStart ||
                                            t.top >= i.gravityYStart) &&
                    ...
                    n.x || n.y
                        ? (wt.move(r.target, n, r.isWindow ? kt : Pt),
                            (e.autoScroll = !0))
                        : wt.stop(),
                        at ||
                        ((at = !0),
                            xt && X(it.element).add(xt),
                            it.onMoveStart && it.onMoveStart(e)),
        ...
        var re = function () {
            ...
            var r = !1,
                o = c.add(function (o) {
                    r ||
                        ((r = !0),
                            it && (n(it, o.type), rt.move(), (t[it._id] = !0)),
                            clearTimeout(e),
